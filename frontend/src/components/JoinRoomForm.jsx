        ...
        <Card className="w-full max-w-md mx-auto">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center">
                <Input type="text" value={roomId} style={{ fontFamily: "'Digital-7 Mono', sans-serif", letterSpacing: "0.1em" }} className="flex-grow" onChange={(e) => setRoomId(e.target.value)} />
              </div>
            </div>
          </CardContent>
          <CardFooter className="flex justify-between items-center">
            <span className="text-gray-500 text-sm">
              ...
              <Link to="/" className="text-blue-600 hover:underline" prefetch={false}>
                Create Room
              </Link>
            </span>
